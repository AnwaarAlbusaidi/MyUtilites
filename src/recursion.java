public class recursion {
	 ...
	 * 
	 * @param base
	 * @param exponent Input = 2,3 // output is 8
	 ...
	 * 
	 * @param number Input 5 // output 120
	 * @return call to the same function to generate the second number in the
	 *         factorial series
	 */
	 ...
	 * 
	 * @param word
	 * @param length Input anwaar // output raawna
	 */
	 ...
	 * 
	 * @param num
	 * @param count Input 4 // output 0 1 2 3 3 2 1 0 Input 5 // output 0 1 2 3 4 4
	 *              3 2 1 0
	 */
	 ...
	 * 
	 * @param n Input 8 /output is 0 1 1 2 3 5 8 13 Input 9 / output is 0 1 1 2 3 5
	 *          8 13 21
	 * @return call to the same function to generate the second number in the
	 *         Fabonacci series
	 */
	 ...
	 * not using recursion
	 * 
	 * @param word Input madam // output true Input something // output false
	...
	public static boolean isPalindrome(String word, int index) {
		...
		return (word.charAt(index) == word.charAt(word.length() - (1 + index))) && isPalindrome(word, index + 1);
	}
